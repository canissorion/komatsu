...
DetalleRendicionModel detalleRendicionFromJson(String str) =>
    DetalleRendicionModel.fromJson(json.decode(str) as Map<String, dynamic>);

String detalleRendicionToJson(DetalleRendicionModel data) =>
    json.encode(data.toJson());

class DetalleRendicionModel extends DetalleRendicionEntitie {
  const DetalleRendicionModel({
  ...
  factory DetalleRendicionModel.fromJson(Map<String, dynamic> json) =>
      DetalleRendicionModel(
