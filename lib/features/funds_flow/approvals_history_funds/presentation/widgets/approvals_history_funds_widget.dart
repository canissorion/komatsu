      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(
              '${orderInfo.sendTo.firstName} ${orderInfo.sendTo.lastName}',
              textAlign: TextAlign.start,
              ...
              if (processes[index].isCompleted) {
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Fecha de Recepcion: ${processes[index].date}",
...
_OrderInfo _data(ApprovalsHistoryFundsEntitie data, int index) => _OrderInfo(
      deliveryProcesses: [
        _DeliveryProcess(
          ...
          date: dateTimeConverter(data.approvals[index].receivedDate),
        ),
        _DeliveryProcess.complete(
          dateTimeConverter(data.approvals[index].receivedDate),
        ),
      ],
    );
...
class _DeliveryProcess {
  ...
  const _DeliveryProcess.complete(this.date)
      : name = 'aprobado',
        messages = const [];
