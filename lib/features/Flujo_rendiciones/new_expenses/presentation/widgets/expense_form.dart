...
import 'package:kcc_mobile_app/features/Flujo_rendiciones/new_expenses/presentation/bloc/new_expenses_bloc.dart';

class ExpensesForm extends StatelessWidget {
  String dropdownValue = 'Komatsu Cummings Chile Ltda';
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<NewExpensesBloc, NewExpensesState>(
        ...
        return SizedBox(
          ...
          child: Column(
            children: [
              ...
              DropDowLlist(dropdownValue: state.currentExpense!),
              const SizedBox(
                height: 10,
              ),
          ...
          child: DecoratedBox(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (String? newValue) {
                BlocProvider.of<NewExpensesBloc>(context, listen: false).add(
                  ChangeItem(newValue!),
                );
                /*setState(() {
