...
DocumentModel documentoFromJson(String str) =>
    DocumentModel.fromJson(json.decode(str) as Map<String, dynamic>);

String documentoModelToJson(DocumentModel data) => json.encode(data.toJson());

class DocumentModel extends DocumentDetailEntitie {
  const DocumentModel({
    required int id,
